...
<%
	BoardQnaBean article = (BoardQnaBean)request.getAttribute("article");
...
<form action="boardModifyPro.bo" method="post" name="modifyform">
	...
	<table>
		...
		<tr>
			...
			<td>
				<textarea id="BOARD_CONTENT" name="BOARD_CONTENT" cols="45" rows="15"><%=article.getBOARD_CONTENT()%></textarea>
			</td>
		</tr>
	</table>
