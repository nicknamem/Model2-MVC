...
//		Oracle 몇번부터 몇번까지
	...
	public BoardBean selectArticle(int board_num) {
		...
		try {
			pstmt = con.prepareStatement("select * from boardreview where BOARD_NUM = ?");
	...
	public int insertReplyArticle(BoardBean article) {
		...
		try {
			...
			if (rs.next())
				...
				num = 1;
			sql = "update boardreview set BOARD_RE_SEQ=BOARD_RE_SEQ+1 "
	...
	public int updateReadCount(int board_num) {
		...
		PreparedStatement pstmt = null;
		int updateCount = 0;
		String sql = "update boardreview set BOARD_READCOUNT = BOARD_READCOUNT+1 where BOARD_NUM = " + board_num;
